...
messages = [
    {"role": "user", "content": "Use the add_two_numbers tool to add 3 and 5."}
]
...
result_value = resp[0].get("output", 0) if isinstance(resp, list) and resp else 0
...
messages = [
    {"role": "user", "content": "Use the calculate_average tool with numbers [10, 20, 30, 40, 50]."}
]
...
print(resp3)
if isinstance(resp3, list) and resp3:
