...
scores = pd.read_csv("prompt_comparison_scores.csv")
...
# Extract p-value
p_val_col = next(c for c in t_test_result.columns if 'p' in c.lower() and 'val' in c.lower())
p_value = t_test_result[p_val_col].values[0]
